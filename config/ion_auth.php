 ...
 */
$config['site_title']                 = 'Expose Online';       // Site Title, example.com
$config['admin_email']                = "admin@expose.org"; // Admin Email, admin@example.com
...
$config['user_expire']                = 129600;               // How long to remember the user (seconds). Set to zero for no expiration - see sess_expiration in CodeIgniter Session Config for session expiration
...
/*
 ...
 | Please customize
 */
$config['session_hash'] = '6583d6c4dE1JZQ$PDeks/7Johhh68a2a2e44ea0006';
