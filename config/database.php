...
$db['development']['char_set'] = 'utf8mb4';
$db['development']['dbcollat'] = 'utf8mb4_unicode_ci';
$db['development']['swap_pre'] = '';
$db['development']['autoinit'] = TRUE;
$db['development']['stricton'] = FALSE;
 
// prod
$db['production']['hostname'] = HOSTNAME;
...
$db['production']['char_set'] = 'utf8mb4';
$db['production']['dbcollat'] = 'utf8mb4_unicode_ci';
...
$mysqli_connection = new MySQLi($db['production']['hostname'],
